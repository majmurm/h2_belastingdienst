...
class SMEAgent(Agent):
    ...
    def step(self):
        ...
        # 1. Global Communication (Reminders)
...
class SMEComplianceModel(Model):
    ...
    def __init__(
        ...
        # Store the distinct channel effects
        ...
        # Setup propensity distribution logic
    ...
    def step(self):
      ...
      if current_week == week_visit_campaign:
          ...
          for s in self.size_order:
              for a in self.age_order:
                  # Proxy for "Sector Risk History": Current group performance vs Target
                  ...
                  if group_mean < self.C_target:
                       ...
                       # Add Cost (Only for agents in this sector)
                       # Uses the pre-calculated count from __init__
...
if __name__ == "__main__":
    ...
    intervention_costs = {
        ...
        'audit': 1550.00          # High cost for detailed audit 1 FTE hr = EUR20.11 --> 78hr per book audit (2024) --> EUR1,569 per audit
    }
    ...
    print(f"ROI (Return per €1 spent on interventions): € {roi_ratio:.2f}")
    print("="*40)
